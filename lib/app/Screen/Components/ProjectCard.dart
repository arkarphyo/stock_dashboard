        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Row(
                children: [
                  _SubtitleText("${data.subtitleText} : "),
                  _CustomerCountTimeText(data.customerCount),
                ],
              ),
            ],
          ),
...
class _CustomerCountTimeText extends StatelessWidget {
  const _CustomerCountTimeText(this.customerCount, {Key? key})
      : super(key: key);
